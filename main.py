...
if __name__ == '__main__':
    ...
    # validatorclarans_adult = validation(clarans.CLARANS, preprocessed_adult_df, pred_adult, 0, 0)
    ...
    # validatorclarans_pen = validation(clarans.CLARANS, preprocessed_pen_df, pred_pen, 0, 0)
